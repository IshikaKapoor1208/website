...
const strengthStats = [
  { value: "500+", label: "Trusted Farmers", detail: "Pan India", Icon: Network },
  { value: "20+", label: "Premium Varieties", detail: "Selected produce", Icon: Boxes },
  { value: "25+", label: "Countries", detail: "Export-ready reach", Icon: Globe2 },
  { value: "100%", label: "Quality Assured", detail: "Every shipment", Icon: ShieldCheck }
];
